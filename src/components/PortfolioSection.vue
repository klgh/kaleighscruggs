...
<template>
  <section
    id="portfolio"
    class="border-t border-border pb-28 pt-20 md:pb-36 md:pt-12"
  >
    <div class="container">
      <div
        class="no-print mb-12 flex flex-col gap-6 md:mb-16 md:flex-row md:items-end md:justify-between"
      >
        <div class="max-w-xl">
          <p
          ...
          <p
            class="mt-4 max-w-[42ch] font-body leading-relaxed text-muted-foreground"
          >
      ...
      <article id="resume" class="resume-doc">
        <header class="resume-header mb-10 border-b border-border pb-8">
          ...
          <p
            class="mt-2 font-body text-base font-medium text-accent md:text-lg"
          >
            {{ resume.headline }}
          </p>
          <p
            class="resume-contact mt-3 font-body text-sm text-muted-foreground"
          >
            {{ contactLine }}
          </p>
          <p
            class="no-print screen-contact mt-3 flex flex-wrap gap-x-4 gap-y-1 font-body text-sm"
          >
        ...
        <section class="resume-block mb-10" aria-labelledby="resume-summary">
          ...
          <p
            class="max-w-[65ch] font-body leading-relaxed text-muted-foreground"
          >
            {{ resume.summary }}
          </p>
        </section>
        ...
        <section class="resume-block mb-10" aria-labelledby="resume-experience">
          ...
          <div class="space-y-8">
            ...
            >
              ...
              <ul
                class="mt-3 list-disc space-y-1.5 pl-5 font-body text-sm leading-relaxed text-muted-foreground"
              >
        ...
        <section class="resume-block" aria-labelledby="resume-volunteer">
          ...
          <ul class="space-y-3 font-body text-sm text-muted-foreground">
            <li
              v-for="item in resume.volunteer"
